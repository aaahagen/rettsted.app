    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-16 flex items-center bg-background/80 backdrop-blur-sm fixed top-0 left-0 right-0 z-50">
        <Link href="#" className="flex items-center justify-center" prefetch={false}>
          ...
          <span className="ml-2 text-xl font-bold font-headline uppercase">Rett Sted</span>
        </Link>
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  Rett Sted er den digitale håndboken som gir sjåførene dine all informasjonen de trenger for raske og problemfrie leveranser, rett i lomma.
                </p>
              </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">&copy; 2024 Rett Sted. Alle rettigheter reservert.</p>
